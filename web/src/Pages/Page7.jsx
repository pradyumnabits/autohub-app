...
function FeedbackForm() {
  ...
  const feedbackTypes = ["vehicle", "service", "dealership"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${AllUrl.feedbackServiceUrl}/feedback/submit`,
        {
  ...
  return (
    <div className="bg-gray-700 min-h-screen p-8 text-white">
      <h1 className="text-2xl font-semibold mb-6 text-center">Feedback Form</h1>
